    ...
    <div class='col-md-10'>
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                <h2>Welcome to your {{env('APP_SHORT')}} dashboard!</h2>
                <p>Use the links on the left hand side to navigate your {{env('APP_SHORT')}} dashboard.</p>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="developer">
                ...
                <p>
                    Documentation:
                    <a href='https://docs.lngx.org/api' target="_blank">https://docs.lngx.org/api</a>
                </p>
